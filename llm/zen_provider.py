"""OpenCode Zen Provider — Coding tasks."""
...
logger = get_logger("llm.zen")


class ZenProvider(LLMProvider):
    """OpenCode Zen provider for coding tasks."""
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            logger.error("Zen error: %s", e)
            return LLMResponse(text=f"Zen error: {e}", provider=self.name, model=model)
