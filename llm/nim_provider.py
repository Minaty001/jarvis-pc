"""NVIDIA NIM Provider — Free vision/multimodal models."""
...
class NIMProvider(LLMProvider):
    """NVIDIA NIM provider for visualization and multimodal tasks."""
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        model = request.model or settings.nvidia_model
        messages = []
        ...
        try:
            ...
            return LLMResponse(text=f"NIM error: {e}", provider=self.name, model=model)
